...
Ниже пример того, как GitHub отрендерит код, который я написал выше:
...
> This project was created for educational purposes to practice STL containers and game logic.
> Проект создан в учебных целях для практики работы с STL и логикой на C++.
